            ...
            <ul class="ticket-list">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '<li class="ticket" data-ticket-id="' . $row["id"] . '" data-ticket-name="' . $row["name"] . '" data-ticket-content="' . $row["content"] . '" data-ticket-attachments="' . $row["attachment"] . '" data-ticket-title="' . $row["title"] . '" data-ticket-department="' . $row["department"] . '" data-ticket-status="' . $row["status"] . '">Ticket ' . $row["id"] . ' - ' . $row["name"] . '</li>';
